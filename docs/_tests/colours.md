...
> Interactive tool for creating harmonious colour palettes and previewing them on website mockups
...
- Test your colours with accessibility checkers
...
- Following trends blindly instead of considering your brand
...
Tech companies often use **blue** as their primary colour:
...
Creative brands often choose bold, unique colours:
- Spotify: Green (#1DB954)
- Twitch: Purple (#9146FF)
- Discord: Purple/Blue (#5865F2)
...
These colours create excitement and grab attention.

## Challenge: Design Your Own

Use the colour picker above to design colour schemes for these fictional websites:

1. **CodeQuest Academy** - A learning platform for teenage programmers
2. **EcoGrow** - A sustainable gardening app
3. **PixelForge Studios** - An indie game development company
4. **MindfulMe** - A meditation and wellness app

Think about:
- What emotions should the brand evoke?
- Who is the target audience?
- What colours would appeal to them?
- How can the accent colour guide user actions?
