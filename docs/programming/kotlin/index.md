...
**Kotlin** is a modern programming language created by JetBrains — the same company that makes IntelliJ IDEA. It was designed to be cleaner and safer than Java, while running on the same platforms.
...
- **Interoperable** — works seamlessly alongside Java code and libraries
