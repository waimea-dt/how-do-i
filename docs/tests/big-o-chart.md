...
<big-o-chart value="5"></big-o-chart>
<big-o-chart value="2"></big-o-chart>

## Only O(1) enabled

<big-o-chart enabled="o1"></big-o-chart>

## Only O(1), O(n), O(n^3) enabled

<big-o-chart enabled="o1 on on3"></big-o-chart>

## Only O(log n), O(n log n), O(n²), O(2ⁿ), O(n!) enabled

<big-o-chart enabled="ologn onlogn on2 o2n ofact"></big-o-chart>
