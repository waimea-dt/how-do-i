...
<knapsack capacity="15" items="2|3 3|4 4|5 5|8 7|9 9|10"></knapsack>
...
<knapsack solve="dynamic" capacity="15" items="2|3 3|4 4|5 5|8 7|9 9|10"></knapsack>

## Greedy by value-to-weight ratio

Greedy sorts items by value per unit of weight. It is fast, but it can miss the best answer.

<knapsack solve="greedy" capacity="15" items="2|3 3|4 4|5 5|8 7|9 9|10"></knapsack>

## Greedy vs. optimal

This set is useful because greedy makes a tempting early choice, but brute force finds a better combination.

<knapsack solve="compare-greedy" capacity="15" items="2|3 3|4 4|5 5|8 7|9 9|10"></knapsack>
...
<knapsack solve="compare-dynamic" capacity="15" items="2|3 3|4 4|5 5|8 7|9 9|10"></knapsack>
