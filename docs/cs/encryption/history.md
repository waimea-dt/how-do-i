...
- 1900 BCE: Ancient Egypt
    ...
    Scribes used non-standard hieroglyphs in inscriptions - one of the earliest known examples of intentionally altered writing.

- 100 BCE: The Caesar Cipher
...
- [Bletchley Park](https://bletchleypark.org.uk/) - the museum built on the site where Enigma was broken
